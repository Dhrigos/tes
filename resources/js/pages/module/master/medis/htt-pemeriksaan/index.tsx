...
export default function Index() {
  ...
  // Computed Values
  const filteredHtt_pemeriksaans = htt_pemeriksaans.filter((a) =>
    a.nama_pemeriksaan.toLowerCase().includes(search.toLowerCase())
  );
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <Dialog open={subOpen} onOpenChange={setSubOpen}>
        <DialogContent className="bg-background border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">
              {subEditId ? "Edit Sub Pemeriksaan" : "Tambah Sub Pemeriksaan"}
            </DialogTitle>
          </DialogHeader>
