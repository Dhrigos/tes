...
export default function Index() {
    ...
    const [kodeObatAlkes, setKodeObatAlkes] = useState('');
    ...
    const handleOpenEdit = (daftarHargaJuals: daftarHargaJuals) => {
        ...
        setKodeObatAlkes(daftarHargaJuals.kode_obat_alkes?.toString() || '');
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Dialog open={deleteOpen} onOpenChange={setDeleteOpen}>
                <DialogContent>
                    ...
                    <p>
                        Apakah Anda yakin ingin menghapus Daftar Harga Jual <span className="font-semibold">{deleteNama}</span>?
                    </p>
                    <DialogFooter>
