...
export default function Index() {
    ...
    const [detailData, setDetailData] = useState<StokObatKlinikItem[]>([]);
    ...
    const submitAdj = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/gudang/stok-obat-klinik/penyesuaian', {
                method: 'POST',
                headers: {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Dialog open={isAdjOpen} onOpenChange={setIsAdjOpen}>
                <DialogContent className="max-h-[90vh] overflow-y-auto text-sm sm:max-w-3xl">
                    ...
                    <form onSubmit={submitAdj} id="adjForm">
                        <div className="space-y-4">
                            ...
                            {/* Expired dihapus sesuai instruksi */}
                        </div>
