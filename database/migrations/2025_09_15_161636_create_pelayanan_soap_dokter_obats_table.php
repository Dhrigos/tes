...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pelayanan_soap_dokter_obats', function (Blueprint $table) {
            ...
            $table->string('penanda', 255);
            $table->string('nama_obat', 255);
            $table->string('jumlah_diberikan', 255)->nullable();
            $table->string('instruksi', 255);
            $table->string('signa', 255);
            $table->string('satuan_gudang', 255);
            $table->string('satuan_signa', 255)->nullable();
            $table->string('penggunaan', 255);
            $table->string('dtd', 255)->nullable();
            $table->string('dtd_mode', 255)->nullable();
